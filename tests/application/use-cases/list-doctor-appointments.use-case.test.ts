...
describe("List Doctor Appointments - Use Case", () => {
  ...
  test("Should list all appointments for a given doctor", async () => {
    ...
    expect(output.appointments[0]?.startDateTime).toBe(slot1.startDateTime.toISOString());
    expect(output.appointments[0]?.endDateTime).toBe(slot1.endDateTime.toISOString());
    ...
    expect(output.appointments[1]?.startDateTime).toBe(slot2.startDateTime.toISOString());
    expect(output.appointments[1]?.endDateTime).toBe(slot2.endDateTime.toISOString());
