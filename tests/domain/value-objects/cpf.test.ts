...
describe("Cpf - Value Object", () => {
  ...
  test.each(["700.000.004-00", "129.841.800-38"])("Should create a Cpf by removing symbols (%s)", (formattedCpf) => {
  ...
  test.each([
    ...
    "88888888888",
    "99999999999",
  ])("Should not create a Cpf if all digits are the same (%s)", (invalidCpf) => {
    const act = () => Cpf.from(invalidCpf);
