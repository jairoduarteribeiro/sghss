...
describe("Availability - Entity", () => {
  ...
  test("Should not allow endDateTime before startDateTime", () => {
    const act = () =>
      Availability.from({
        startDateTime: new Date("2024-07-01T17:00:00.000Z"),
  ...
  test("Should not allow different between startDateTime and endDateTime less than 30 minutes", () => {
    const act = () =>
      Availability.from({
        ...
        endDateTime: new Date("2024-07-01T09:15:00.000Z"),
        doctorId: Uuid.generate(),
      });
  ...
  test("Should not allow times not multiples of 30 minutes", () => {
    const act = () =>
      Availability.from({
        startDateTime: new Date("2024-07-01T09:10:00.000Z"),
        endDateTime: new Date("2024-07-01T09:50:00.000Z"),
        doctorId: Uuid.generate(),
      });
  ...
  test("Should not allow availability more than 4 hours", () => {
    const act = () =>
      Availability.from({
        startDateTime: new Date("2024-07-01T09:00:00.000Z"),
        endDateTime: new Date("2024-07-01T14:30:00.000Z"),
        doctorId: Uuid.generate(),
      });
